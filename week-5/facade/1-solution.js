...
// This is just a simpliest solution for testing purposes;
const IS_BROWSER_ENV = typeof window !== 'undefined';

const createTimeout = (cb, time) => {
  const timeout = setTimeout(cb, time);

  if (IS_BROWSER_ENV) return timeout;
...
TimeoutCollection.prototype.set = function (key, value, flag) {
